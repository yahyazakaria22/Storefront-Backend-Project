...
describe('Order CRUD', function () {
    ...
    it('gets the /orders/:id endpoint', function (done) {
        request.get("/orders/".concat(user_Id)).then(function (res) {
            expect(res.status).toBe(200);
            done();
        });
    });
    it('add method test', function () { return __awaiter(void 0, void 0, void 0, function () {
        var createUser, createOrder;
        return __generator(this, function (_a) {
            switch (_a.label) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    createOrder = _a.sent();
                    order_id = createOrder.id;
                    return [4 /*yield*/, store.show(order_id.toString())];
                case 2:
                    orderShow = _a.sent();
    ...
    it('update method test', function () { return __awaiter(void 0, void 0, void 0, function () {
        var createOrder, newOrder, orderShow;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, store.create(order)];
                case 1:
                    ...
                    return [4 /*yield*/, store.put(order_id.toString(), newOrder.status, newOrder.user_id)];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, store.show(order_id.toString())];
                case 3:
