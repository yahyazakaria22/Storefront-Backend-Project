...
var _a = process.env, BYCRPT_PASSWORD = _a.BYCRPT_PASSWORD, SALT_ROUNDS = _a.SALT_ROUNDS;
var saltRounds = SALT_ROUNDS || '';
var pepper = BYCRPT_PASSWORD || '';
var UserStore = /** @class */ (function () {
    ...
    UserStore.prototype.put = function (id, username, password) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'UPDATE users SET username=($2),password_digest=($3)  WHERE id=($1)';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        hash = bcrypt_1.default.hashSync(password + pepper, parseInt(saltRounds));
                        return [4 /*yield*/, conn.query(sql, [id, username, hash])];
                    case 2:
                        result = _a.sent();
                        User = result.rows[0];
                        conn.release();
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not edit User ".concat(id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
