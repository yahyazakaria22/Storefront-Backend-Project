        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("unable create Product (".concat(u.name, "): ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    ProductStore.prototype.put = function (id, name, price) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'UPDATE Products SET name=($2),price=($3)  WHERE id=($1)';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn.query(sql, [id, name, price])];
                    case 2:
                        result = _a.sent();
                        Product = result.rows[0];
                        conn.release();
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not edit Product ".concat(id, ". Error: ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
