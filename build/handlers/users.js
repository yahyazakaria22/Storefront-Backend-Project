...
var edit = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.put(req.params.id, req.body.username, req.body.password)];
            case 1:
                put = _a.sent();
                res.json(put);
                return [3 /*break*/, 3];
...
var userRoutes = function (app) {
    ...
    app.put('/users/:id', authorization_1.verifyAuthToken, edit);
    app.post('/users', create);
    app.delete('/users/:id', authorization_1.verifyAuthToken, destroy);
};
