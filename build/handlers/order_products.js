...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.create(req.body.quantity, req.body.order_id, req.body.product_id)];
            case 1:
                order_products = _a.sent();
                res.json(order_products);
                return [2 /*return*/];
...
var edit = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.put(req.params.id, req.body.quantity, req.body.order_id, req.body.product_id)];
            case 1:
                put = _a.sent();
                res.json(put);
                return [2 /*return*/];
...
var OrderProductRoutes = function (app) {
    ...
    app.put('/order_products/:id', authorization_1.verifyAuthToken, edit);
    app.post('/order_products', authorization_1.verifyAuthToken, create);
    app.delete('/order_products/:id', authorization_1.verifyAuthToken, destroy);
};
