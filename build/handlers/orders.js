...
var edit = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.put(req.params.id, req.body.status, req.body.user_id)];
            case 1:
                put = _a.sent();
                res.json(put);
                return [2 /*return*/];
...
var OrderRoutes = function (app) {
    ...
    app.put('/orders/:id', authorization_1.verifyAuthToken, edit);
    app.post('/orders', authorization_1.verifyAuthToken, create);
    app.delete('/orders/:id', authorization_1.verifyAuthToken, destroy);
};
