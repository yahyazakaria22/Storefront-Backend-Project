...
var edit = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, store.put(req.params.id, req.body.name, req.body.price)];
            case 1:
                put = _a.sent();
                res.json(put);
                return [2 /*return*/];
...
var ProductRoutes = function (app) {
    ...
    app.put('/products/:id', authorization_1.verifyAuthToken, edit);
    app.post('/products', authorization_1.verifyAuthToken, create);
    app.delete('/products/:id', authorization_1.verifyAuthToken, destroy);
};
